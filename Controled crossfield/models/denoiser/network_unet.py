...
# --- PERBAIKAN IMPORT AGAR BISA DIBACA DARI APP.PY ---
try:
    # Cara 1: Relative Import (Saat dijalankan lewat app.py/baseline_arch)
    from . import basicblock as B
except ImportError:
    try:
        # Cara 2: Absolute Import (Jika folder models sudah di sys.path)
        from denoiser import basicblock as B
    except ImportError:
        # Cara 3: Local Import (Jika file dijalankan langsung sendiri)
...
# ====================
'''
# ... (lanjutkan kode class UNet ke bawah seperti biasa)
