...
def visualize_progression(
    ...
    baseline_path, 
    dsc_paths_dict, 
    save_path="outputs/comparison_analysis50.png"
):
    """
...
if __name__ == "__main__":
    ...
    visualize_progression(
        ...
        noisy_path="visual/visual_test50/noisy.webp",      # Ganti
        baseline_path="visual/visual_test50/baseline.webp",             # Ganti
        dsc_paths_dict={
            5: "visual/visual_test50/DSC5.webp",    # Ganti
            10: "visual/visual_test50/DSC10.webp",  # Ganti
            15: "visual/visual_test50/DSC15.webp",  # Ganti
            20: "visual/visual_test50/DSC20.webp"   # Ganti
        }
    )