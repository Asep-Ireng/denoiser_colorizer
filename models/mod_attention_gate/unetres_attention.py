...
# Add denoiser folder to path for basicblock import
_MODELS_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, os.path.join(_MODELS_DIR, 'denoiser'))

try:
    import basicblock as B
except ImportError as e:
    print(f"Error importing basicblock: {e}")
    sys.exit(1)

# 1. MODUL ATTENTION GATE
...
# 2. ARSITEKTUR UTAMA: Attention DRUNet
